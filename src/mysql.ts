...
class MySQL {
    ...
    static async insert(table: string, data: any): Promise<number> {
    ...
    static async update(table: string, data: any): Promise<boolean> {
        const columns = await this.getColumns(table);
    ...
    static async selectByFields(table: string, fields: { [key: string]: any }): Promise<{ [key: string]: any }> {
